package it.prova.gestioneprodottijspservletjpamaven.web.listener;
...
public class LocalEntityManagerFactoryListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("gestioneprodottijspservletjpamaven_unit");
		} catch (Throwable ex) {
